...
import com.ravi.service.UserExistsException;
import com.ravi.service.UserManager;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.ravi.service.UserService")
